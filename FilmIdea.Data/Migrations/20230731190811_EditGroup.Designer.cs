...
namespace FilmIdea.Data.Migrations
{
    ...
    [Migration("20230731190811_EditGroup")]
            ...
            modelBuilder.Entity("FilmIdea.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b6615212-9b74-4e4e-a31a-d3b6c84c1369",
                            Email = "user@user.bg",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c1a87784-f8ba-4974-9f07-11d7f2aa8713",
            ...
            modelBuilder.Entity("FilmIdea.Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("991cc70d-c0aa-44c7-b6b7-ccd58d3796fa"),
                            CommentDate = new DateTime(2023, 7, 31, 19, 8, 10, 476, DateTimeKind.Utc).AddTicks(4378),
            ...
            modelBuilder.Entity("FilmIdea.Data.Models.Movie", b =>
                {
                    ...
                    b.HasOne("FilmIdea.Data.Models.Group", null)
                        .WithMany("Watchlist")
                        .HasForeignKey("GroupId");
